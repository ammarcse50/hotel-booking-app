...
const AdminHomeUi = () => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    if (!name || !alias || !file) {
      console.log('Name, alias, and file are required.');
      return;
    }
  ...
  return (
    <>
      <form onSubmit={handleOnSubmit}>
        <div className='flex w-full gap-5'> <Input type="text" name="name" placeholder="Hotel Name" className='m-3' required />
        ...
        <div className='flex w-full gap-5 mb-10'>
          ...
          <div>
            <label className='m-3'>
              ...
              <input type="file" name="file" onChange={onChange} className="px-2" required />
            </label>
            <div className='m-3 flex gap-2'>
